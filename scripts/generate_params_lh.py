...
def main():
    ...
    #generate_LH(param_names_vary, n_samples, fn_params, fn_params_fixed, seed=seed)
    
    fn_rands = f'{dir_params}/randints{tag_params}.npy'
    utils.generate_randints(n_samples, fn_rands)


def generate_LH(param_names_vary, n_samples, fn_params, fn_params_fixed, seed=42):
