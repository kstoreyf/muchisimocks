...
for n_train in "${n_train_arr[@]}"; do
    for tag_stats in "${tag_stats_arr[@]}"; do
        config_file="../configs/configs_test/config_TRAIN_muchisimocks${tag_stats}_p5_n10000_biaszen_p4_n100000_ntrain${n_train}_TEST_muchisimocks${tag_stats}_quijote_p0_n1000_b1000_p0_n1_mean.yaml"
